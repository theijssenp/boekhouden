...
// Option to also insert directly into database
if (isset($_GET['insert']) && $_GET['insert'] === 'true') {
    echo "\n-- Inserting data into database...\n";
    
    // Read the generated SQL and execute
    $sql_content = ob_get_contents();
    ob_end_clean();
    ...
    try {
        ...
        echo "Sample data successfully inserted into database.\n";
    } catch (Exception $e) {
